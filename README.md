...
### Code style
Code is formatted according to the [Linux Kernel Style](https://www.kernel.org/doc/html/latest/process/coding-style.html), a slight modification of the style of the prophets, Keninghan & Ritchie. I use it because, in Linus Torvald's own words, "(a) K&R are **right** and (b) K&R are right."
